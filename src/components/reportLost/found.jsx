    ...
    function Found({ onClose }) {
        const context = useContext(MyContext);
        const { products, setProducts, addProduct, categories, mode } = context;
        const [imageFile, setImageFile] = useState(null);
        const [uploading, setUploading] = useState(false);
        
        // Initialize component and set type to "found"
        useEffect(() => {
            // Set the type to found when this component mounts
            setProducts(prev => ({
                ...prev,
                type: "found",
                location: {
        ...
        return (
            <>
                ...
                <div className={`sticky top-0 ${bgColor} p-4 border-b ${borderColor} rounded-t-lg flex justify-between items-center z-10`}>
                    <h1 className={`${textColor} text-xl font-bold`}>Report Found Item</h1>
                    <button 
                        onClick={onClose} 
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div className="mb-4">
                                ...
                                <textarea 
                                    name="description" 
                                    placeholder="Please describe the item you found"
                                    className={`${inputBgColor} px-4 py-2 w-full rounded-lg ${textColor} ${inputPlaceholderColor} outline-none`}
                                    rows="4"
                        ...
                        <div>
                            ...
                            <div className="mb-4 ">
                                <label className={`block ${textColor} mb-2`}>
                                    Attach an image of the Found Item
                                </label>
                                <input 
                                    type="file" 
